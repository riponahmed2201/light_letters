...
jQuery('body').on('click', '#quick_reply_check', function (event) {
...
jQuery('body').on('click', '#no_reply_check', function (event) {
    if ($("#no_reply_check").prop('checked') == true) {
        $("#search").val('@replyStatus');
    } else {
        $("#search").val('');
    }
});
jQuery('body').on('click', '#reminder_check', function (event) {
    if ($("#reminder_check").prop('checked') == true) {
        
        $("#search").val('@remainder');
    } else {
        $("#search").val('');
    }
});
