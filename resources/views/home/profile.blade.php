                ...
                @if (isset($customerInfo))
                    <li class="nav-item dropdown">
                        <img src="{{ asset('/uploads/customer_pro_pic/' . $customerInfo->profile_picture) }}"
                            alt="Profile_pic" class="top_nav_img dropdown-toggle" id="profile_dropdownMenu"
                        ...
                        <div class="card profile_content_form">
                            <div class="card-body profile_card_body ">
                                <form action="{{ url('/update-customer/') }}" method="post" enctype="multipart/form-data"
                                    class="profile_form" id="profile_form">
                                    @csrf
                                    @method('PUT')
                                    <div class="form-group d-flex justify-content-center align-content-center">
                                        <div class="" style="position: relative;">
                                            @if (isset($customerInfo->status))
                                            <input id="cus__status" type="hidden" name="check_customer_status"
                                            value="{{ $customerInfo->status }}">
                                            @endif

                                            @if (isset($customerInfo->profile_picture))
                                                <img id="profile_picture_preview" src="{{ asset('/uploads/customer_pro_pic/' . $customerInfo->profile_picture) }}"
                                                    alt="Avatar" style="width:80px;border-radius: 20%;" />
                                            @else
                                                <img src="{{ asset('/uploads/customer_pro_pic/default_customer.png') }}"
                                                    alt="Avatar" style="width:80px;border-radius: 20%;" />
                                            @endif
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4 right_align"> Edit
                                            <i class="fas fa-edit fa-edit click_shake" id="edit"
                                             ...
                                             })();return confirm('Are you sure? Your status will changed to pending as image and address changes will required verification from admin.');"></i>
                                        </div>
                                    </div><br>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="name" class="form-control info_edit_disabled" id="first_name"
                                            name="first_name" value="{{ $customerInfo->first_name }}">
                                        <p style="color: darkred;font-size: smaller">[NB: Click on edit button to edit]</p>
                                    </div><br>

                                    <div class="form-group">
                                        <label for="name">Last Name</label>
                                        <input type="name" class="form-control info_edit_disabled" id="last_name"
                                            name="last_name" value="{{ $customerInfo->last_name }}">
                                        <p style="color: darkred;font-size: smaller">[NB: Click on edit button to edit]</p>
                                    </div><br>

                                    <div class="form-group">
                                        <label for="email">Email </label>
                                        <input type="email" class="form-control disabled_with_background" id="email"
                                    ...
                                    @if ($customerInfo->nid != 'no_data')
                                        <div>
                                            <div class="form-group">
                                                ...
                                                <span class="small ml-auto" style="color: #213f7e;float: right;">[NB: Able
                                                    to upload just for One time]</span>

                                                <select class="form-control info_edit_disabled disabled_with_background"
                                                    name="id_type">
                                            ...
                                            <div class="form-group" style="display: flex;">
                                                <label
                                                    class="upload-label progress_bar_file info_edit_disabled disabled_with_background ">
                                    ...
                                    @else
                                        <div class="form-group">
                                            <label for="id_type">Proof of ID</label>
                                            <span class="small ml-auto" style="color: #213f7e;float: right;">[NB: Able to
                                                upload just for One time]</span>
                                            <select class="form-control info_edit_disabled disabled_with_background"
                                        ...
                                        <div class="form-group" id="select_alert" style="display: flex;">
                                            <label
                                                class="upload-label progress_bar_file info_edit_disabled disabled_with_background id_type_mandatory"
                                                id="id_type_click">
                                                <input type="file" class="nid_file" name="nid">
                                                <span class="upload-file-label ">Upload File</span>
                                    ...
                                    @else
                                        ...
                                        <div class="form-group" style="display: flex;" id="select_alert2">
                                            <label
                                                class="upload-label_2 progress_bar_file_2 info_edit_disabled ra_type_mandatory"
                                                id="ra_type_click">
                                                <input type="file" class="residential_file" name="ra_file">
                                                <span class="upload-file-label ">Upload File</span>
                                    ...
                                    <div class="form-row">
                                        @if ($customerInfo->house)
                                            <div class="form-group col-md-2">
                                                ...
                                                <input type="text" class="form-control info_edit_disabled" name="house"
                                                    id="inputHouse" value="{{ $customerInfo->house }}">
                                            </div>
                                        @else
                                            <div class="form-group col-md-2">
                                                <label for="inputHouse">House</label>
                                                <input type="text" class="form-control info_edit_disabled" name="house"
                                                    id="inputHouse" placeholder="HN">
                                            </div>
                                        @endif
                                        @if ($customerInfo->road)
                                            <div class="form-group col-md-5">
                                                <label for="inputRoad">Road</label>
                                                <input type="text" class="form-control info_edit_disabled" name="road"
                                                    id="inputRoad" value="{{ $customerInfo->road }}">
                                            </div>
                                        @else
                                            <div class="form-group col-md-5">
                                                <label for="inputRoad">Road</label>
                                                <input type="text" class="form-control info_edit_disabled" name="road"
                                                    id="inputRoad" placeholder="Road">
                                            </div>
                                        @endif
                                        @if ($customerInfo->city)
                                            <div class="form-group col-md-5">
                                                <label for="inputCity">City</label>
                                                <input type="text" class="form-control info_edit_disabled" name="city"
                                                    id="inputCity" value="{{ $customerInfo->city }}">
                                            </div>
                                        @else
                                            <div class="form-group col-md-5">
                                                <label for="inputCity">City</label>
                                        ...
                                        @if ($customerInfo->zip)
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control info_edit_disabled" name="zip"
                                                    id="inputZip" value="{{ $customerInfo->zip }}">
                                            </div>
                                        @else
                                            <div class="form-group col-md-6">
                                                <label for="inputZip">Zip Code</label>
                                        ...
                                        @if ($customerInfo->country)
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control info_edit_disabled" name="country"
                                                    id="inputCountry" value="{{ $customerInfo->country }}">
                                            </div>
                                        @else
                                            <div class="form-group col-md-6">
                                                <label for="inputCountry">Country Name</label>
                                    ...
                                    @if ($customerInfo->phone)
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control info_edit_disabled" id="number"
                                    ...
                                    <div class=" text-center">
                                        <button type="submit" class="btn btn-block btn-primary"
                                            style="background-color: #4195D1;">Save</button>
                                    </div>
                                </form><br><br>
                                <br>
