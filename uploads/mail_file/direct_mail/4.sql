...
--
-- Host: localhost:3306
-- Generation Time: Feb 23, 2021 at 10:19 AM
...
INSERT INTO `admins` (`id`, `client_id`, `name`, `email`, `password`, `role`, `profile_picture`, `created_at`, `updated_at`) VALUES
(1, NULL, 'Super Admin', 'superadmin@light-letters.co.uk', '$2y$12$w6IFtIKz8a.bZu1q/6dSeOavcM9xjYplOwOrpCa7MUoT2ZQilB/2m', 'super_admin', 'default_admin.png', NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `admin_password_changes`
--
...
INSERT INTO `clients` (`id`, `name`, `email`, `password`, `profile_picture`, `status`, `company`, `activation_status`, `admin_id`, `role`, `company_address`, `company_reg_no`, `company_bit_no`, `company_contact_person`, `contact_person_designation`, `number_of_employee`, `created_at`, `updated_at`) VALUES
(1, 'Super Client', 'superclient@light-letters.co.uk', '$2y$12$w6IFtIKz8a.bZu1q/6dSeOavcM9xjYplOwOrpCa7MUoT2ZQilB/2m', 'default_client.png', 'admin', NULL, 'activate', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
(31, '2021_02_23_031218_create_admin_password_changes_table', 1);
...
--
-- Indexes for table `admin_password_changes`
--
ALTER TABLE `admin_password_changes`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `admin_password_changes`
--
ALTER TABLE `admin_password_changes`
